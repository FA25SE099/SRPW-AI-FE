...
import { CultivationPlanModal } from "@/features/cultivation-plan/components/cultivation-plan-modal";
                        ...
                        <div className="flex-1 flex flex-col overflow-hidden bg-gray-50">
                            ...
                            {!isLoading && plan && group && (
                                <div className="flex-1 overflow-y-auto">
                                    {/* ...existing plan header and overview cards... */}
                                    ...
                                    <div className="p-6">
                                        ...
                                        {/* Tabs with Plots section updated */}
                                        <Tabs defaultValue="overview" className="w-full">
                                            <TabsList className="grid w-full grid-cols-4 bg-white border-0 p-1 h-auto">
                                                <TabsTrigger value="overview" className="data-[state=active]:bg-blue-50 data-[state=active]:text-blue-700 py-3">
                                                    <FileText className="w-4 h-4 mr-2" />
                                                    Overview
                                                </TabsTrigger>
                                                <TabsTrigger value="plots" className="data-[state=active]:bg-blue-50 data-[state=active]:text-blue-700 py-3">
                                                    <MapPin className="w-4 h-4 mr-2" />
                                                    Plots ({group.plots?.length || 0})
                                                </TabsTrigger>
                                                <TabsTrigger value="timeline" className="data-[state=active]:bg-blue-50 data-[state=active]:text-blue-700 py-3">
                                                    <Clock className="w-4 h-4 mr-2" />
                                                    Timeline
                                                </TabsTrigger>
                                                <TabsTrigger value="analytics" className="data-[state=active]:bg-blue-50 data-[state=active]:text-blue-700 py-3">
                                            ...
                                            <div className="mt-6">
                                                ...
                                                {/* Updated Plots Tab with View Cultivation Plan button */}
                                                                    ...
                                                                    <div className="flex items-start justify-between">
                                                                        <div className="flex items-start gap-4 flex-1">
                                                                            ...
                                                                            <div className="flex-1">
                                                                                ...
                                                                                {/* View Cultivation Plan Button */}
                                                                                <Button
                                                                                    variant="outline"
                                                                                    size="sm"
                                                                                    className="mt-4 hover:bg-emerald-50 hover:text-emerald-700 hover:border-emerald-300 transition-colors"
                                                                                    onClick={() => {
                                                                                        setSelectedPlotId(plot.id);
                                                                                        setSelectedPlotName(`Plot ${plot.soThua}/${plot.soTo}`);
                                                                                    }}
                                                                                >
                                                ...
                                                {/* ...existing timeline and analytics tabs... */}
            ...
            {selectedPlotId && (
                <CultivationPlanModal
                    ...
                    onClose={() => {
                        ...
                        setSelectedPlotName(null);
                    }}
                    plotId={selectedPlotId}
                    plotName={selectedPlotName || undefined}
                />
            )}
        </>
    );
