    ...
    return (
        <div className="space-y-4">
            <div className="flex items-center justify-between">
                <div>
                    <h2 className="text-2xl font-semibold">Cluster Managers</h2>
                        ...
                        <tbody className="divide-y divide-gray-200">
                            {managers.map((manager: any) => (
                                <tr key={manager.clusterManagerId} className="hover:bg-gray-50">
                                    <td className="px-4 py-3 text-sm">{manager.clusterManagerName}</td>
                                    <td className="px-4 py-3 text-sm">{manager.email}</td>
                                    <td className="px-4 py-3 text-sm">{manager.clusterManagerPhoneNumber}</td>
                                    <td className="px-4 py-3 text-sm">
                                        <span
                                            className={`px-2 py-1 text-xs rounded-full ${manager.assignedDate
                                    ...
                                    <td className="px-4 py-3 text-sm">{manager.clusterName || '-'}</td>
                                    <td className="px-4 py-3 text-sm">
