    ...
    mutationConfig: {
      ...
      onError: (err: any) =>
        addNotification?.({
          type: 'error',
          title: 'Lỗi',
          message: err?.message || 'Không thể tạo chuyên gia',
        }),
    },
  });
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-semibold">Chuyên gia nông học</h2>
          <p className="mt-1 text-sm text-gray-600">
            Quản lý chuyên gia nông học và phân công của họ
          </p>
        </div>
        <Dialog open={isCreateOpen} onOpenChange={setIsCreateOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              <DialogTitle>Tạo chuyên gia mới</DialogTitle>
            </DialogHeader>
