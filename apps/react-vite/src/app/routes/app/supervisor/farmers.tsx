...
import { useSupervisorFarmers } from '@/features/supervisor/api/get-supervisor-farmers';
import { SupervisorFarmerDetailDialog } from '@/features/supervisor/components/supervisor-farmer-detail-dialog';
import { Head } from '@/components/seo/head';

const SupervisorFarmersPage = () => {
    ...
    const { data, isLoading, isError } = useSupervisorFarmers({
        params: {
            onlyAssigned,
                                        ...
                                        <tr key={farmer.farmerId} className="hover:bg-gray-50">
                                            ...
                                            <td className="px-6 py-4">
                                                <div className="flex items-center gap-2 text-sm text-gray-900">
                                                    ...
                                                    <span className="line-clamp-2">{farmer.address || 'N/A'}</span>
                                                </div>
                                            </td>
                                            <td className="whitespace-nowrap px-6 py-4">
...
export const Component = SupervisorFarmersPage;
export default SupervisorFarmersPage;
